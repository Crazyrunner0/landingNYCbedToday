 ...
 * Description: An autoloader that enables standard plugins to be required via Composer
 * Version: 1.0.0
 * Author: Roots
 * Author URI: https://roots.io/bedrock/
 * License: MIT License
 */
...
class Autoloader
{
    ...
    public function loadPlugins()
    {
        ...
        array_map(static function () {
            require_once WPMU_PLUGIN_DIR . '/' . func_get_args()[0];
     ...
     * loaded as usual. Plugins are removed from the `$this->activated` array
     * after the hook is called.
     * {@internal The `$this->activated` array is populated before the plugins
     * are loaded. After plugins are loaded, we can check if they have any hooks.}
     */
    ...
    private function countPlugins()
    {
        ...
        $count = count(self::$cache['plugins']);
