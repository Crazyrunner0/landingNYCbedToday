(function (window, wp) {
    ...
    var i18n = wp.i18n || { __: function (str) { return str; } };
    ...
    function renderRichTextField(field, value, onChange) {
        ...
        if (field.label) {
            children.push(createElement(
                'span',
                { className: 'nycbedtoday-block-editor__label' },
                field.label
            ));
        }
    ...
    library.blocks.forEach(function (blockConfig) {
        ...
        registerBlockType(blockConfig.name, {
            ...
            edit: function (props) {
                ...
                var blockProps = useBlockProps({ className: blockConfig.className ? blockConfig.className + ' nycbedtoday-block' : 'nycbedtoday-block' });
                ...
                return createElement(
                    Fragment,
                    null,
                    inspectorFields.length > 0 && createElement(
                        InspectorControls,
                        null,
                        createElement(
                            PanelBody,
